...
export const FORMATIONS: readonly Formation[] = [
  ...
  },
  {
    ...
    promesse:
      'Créez des assistants IA adaptés à votre poste et aux tâches récurrentes de votre équipe. Formation pratique de 7 heures en présentiel en Île-de-France.',
    casUsageCourts: [
      'Configurer un assistant métier',
      'Maîtriser ChatGPT et Claude',
      'Structurer ses prompts réutilisables',
    ],
    gamme: 'appliquer-metier',
    ...
    objectifs: [
      'Créer des assistants IA personnalisés adaptés à son poste et des assistants transverses pour l’équipe',
    ...
    public:
      'Fonctions support et métiers du BTP : assistant(e)s travaux, assistant(e)s polyvalent(e)s, comptabilité, direction administrative et financière, dirigeants, conducteurs de travaux et chargés d’affaires',
    casUsage: 'GPTs ChatGPT, Projects Claude — assistants métier et prompts réutilisables',
    pdfProgramme:
