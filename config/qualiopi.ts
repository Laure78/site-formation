...
export const QUALIOPI_STATS = {
  ...
  PERIODE_REFERENCE: PREUVES_PERIODE.label,
...
export const QUALIOPI_ACCESSIBILITE_EXACT =
  "Accessibilité : mes formations sont accessibles aux personnes en situation de handicap. Référente handicap : Laure Olivié (laureolivie@yahoo.fr · 06 95 66 18 18) — à contacter en amont de l'inscription afin d'étudier ensemble les aménagements possibles (pédagogiques, matériels, organisationnels).";
