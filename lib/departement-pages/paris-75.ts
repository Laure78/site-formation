...
export const DEPARTEMENT_PARIS_75: DepartementPageData = {
  ...
  slug: 'paris',
  accroche:
    "Formation IA pour le BTP en présentiel à Paris : devis, DCE et comptes rendus sur vos documents réels, en intra (dans vos locaux) ou en inter. Le bassin parisien intra-muros impose des contraintes spécifiques — site occupé, copropriétés, accès chantiers et exigences patrimoniales — que la session traite avec vos pièces concrètes.",
  villes: [
  ...
  faqLocale: [
    {
      ...
      a: 'Oui. Les sessions ont lieu en présentiel à Paris, en intra (dans vos locaux) ou en inter — présentiel uniquement · Île-de-France uniquement. Arrondissements centre, est et ouest se traitent de la même façon.',
    },
    {
