  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        `Le module est éligible à un financement selon dossier 2026 (24 € HT/h/stagiaire). Indicateurs publiés : ${formatProsFormesEtNoteQualiopi()}.`,
      ],
    },
    {
      type: 'html',
...
<p class="mt-4"><a href="/prendre-rendez-vous">Échanger sur votre projet de formation</a></p>`,
    },
  ],
};
