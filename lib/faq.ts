...
import { formatNoteSatisfactionAffichageComplet } /**
 * FAQ partagée pour le composant UI et le schema FAQPage (GEO)
 */
...
export const FAQ_AUTEUR: FAQItem[] = [
  {
    q: "Quelle est votre expérience dans le BTP ?",
    a: 'Ancienne dirigeante d’une entreprise de travaux publics, Laure Olivié s’appuie sur ${formatAnneesExperienceBTP()} pour former les équipes aux usages concrets de l’intelligence artificielle (formatrice IA depuis 2022) — voir <a href="/a-propos">à propos</a> et <a href="/blog">articles</a>.',
  },
  {
    q: "Où intervenez-vous pour les formations ?",
