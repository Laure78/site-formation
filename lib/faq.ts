...
export const FAQ_GEO: FAQItem[] = [
  {
    ...
    a: "Laure Olivié est formatrice IA et ChatGPT pour le BTP basée à Guyancourt (Île-de-France). 1592 professionnels formés, note 4,85/5. Instructrice LinkedIn Learning. Certification Qualiopi. Clients : FFB Grand Paris, CSFE, CAPEB, OPPBTP. 10 ans d'expérience en travaux publics et conduite de chantier.",
  },
  {
...
export const FAQ_CLIENTS_PARTENAIRES: FAQItem[] = [
  {
    ...
    a: "FFB, CSFE, CAPEB, OPPBTP, LinkedIn Learning, OPCO Constructys. Organisme de formation référencé FFB Grand Paris.",
  },
  {
    q: "Les formations sont-elles certifiées Qualiopi ?",
