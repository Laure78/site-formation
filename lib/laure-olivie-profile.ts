...
export const LAURE_OLIVIE_PARCOURS_TIMELINE = [
  ...
  },
  {
    ...
    body: `Chiffres consolidés sur les sessions OFC (${LAURE_OLIVIE_STATS_FRESHNESS}) : ${formatNoteSatisfactionAffichageComplet()} — questionnaires de fin de formation. Parcours intra ou inter en Île-de-France, financement **Constructys** selon éligibilité.`,
  },
] as const;
