...
const DEFAULT_BLOG_FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Le conducteur de travaux peut utiliser l'IA pour rédiger des comptes rendus de chantier, analyser les DCE et CCTP, automatiser ses emails et relances, et préparer des mémoires techniques. La formation IA pour le BTP de Laure Olivié (4h, intra (dans vos locaux) ou inter) couvre ces cas d'usage avec des prompts ChatGPT adaptés au vocabulaire chantier.",
  },
  {
  ...
  },
  {
    ...
    a: "Les formations IA appliquées au bâtiment de Laure Olivié durent 4 heures en format intra (dans vos locaux) ou inter. Des modules combinés (2×4h) sont disponibles pour approfondir les appels d'offres ou le chiffrage. Les formations se déroulent en présentiel, intra ou inter ou sur site (FFB, CSFE en intra-entreprise).",
  },
  {
  ...
  },
  {
    ...
    a: `Oui pour les sessions OFC : présentiel uniquement · Île-de-France uniquement (${IDF_ZONE_INTERVENTION}), en intra (dans vos locaux) ou inter. L'échange préalable de cadrage (30 min) peut se faire en visio.`,
  },
] as const;
