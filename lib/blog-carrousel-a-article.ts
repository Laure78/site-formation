...
export const carrouselAFormationArticle: BlogArticle = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        'Les formations OFC (NIV-01, NIV-02) : présentiel uniquement · Île-de-France uniquement — intra (dans vos locaux) ou inter. Les modalités définitives figurent sur votre proposition de formation et la convention signée.',
    },
    {
      type: 'html',
