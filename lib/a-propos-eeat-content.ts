...
export const A_PROPOS_CLIENTS_CATEGORIES = [
  ...
  },
  {
    ...
    items: ['CNAM Entreprise (Île-de-France)', 'Le Moniteur Formations', 'Bureaux d\'études structure et fluides'],
  },
] as const;
