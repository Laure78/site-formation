...
export const FORMATION_IA_CONSTRUCTION_SEO = {
  ...
  description:
    "Formation IA construction en présentiel Île-de-France : DCE, chiffrage, appels d'offres. Qualiopi, finançable par Constructys selon éligibilité. Prendre rendez-vous.",
...
export const CONSTRUCTION_FAQ = [
  ...
  },
  {
    ...
    a: `Session catalogue de 4 heures en présentiel — intra (dans vos locaux) ou inter en Île-de-France. ${MODALITE_FORMATIONS_STANDARD} Contenu adapté aux équipes études, direction travaux et fonctions support des entreprises de construction.`,
  },
  {
