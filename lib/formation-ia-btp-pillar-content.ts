...
/** Page pilier SEO — `/formation-ia-btp` (formation IA pour le BTP / formation IA bâtiment). */
export const FORMATION_IA_BTP_PILLAR_PATH = '/formation-ia-btp' as const;

/** Title SEO ≤ 65 car. (format projet). Évite la juxtaposition « IA BTP » (nom d’entreprise). */
export const FORMATION_IA_BTP_PILLAR_TITLE =
  'Formation IA pour le BTP : IA bâtiment | Laure Olivié';
