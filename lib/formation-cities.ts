...
export const FORMATION_CITIES: Record<string, CityFormationConfig> = {
  lyon: {
    ...
    zones: [
      { num: '69', nom: 'Lyon', contenu: 'Tous arrondissements • Sessions en présentiel ou distanciel • Métropole de Lyon' },
      { num: '69', nom: 'Villeurbanne', contenu: 'Deuxième ville de la métropole • Formation intra-entreprise ou distanciel' },
      ...
      { num: '69', nom: 'Bron', contenu: 'Intervention dans vos locaux ou en visio' },
  ...
  bordeaux: {
    ...
    zones: [
      { num: '33', nom: 'Bordeaux', contenu: 'Tous quartiers • Sessions en présentiel ou distanciel • Métropole bordelaise' },
      ...
      { num: '33', nom: 'Bègles', contenu: 'Intervention dans vos locaux ou en visio' },
  ...
  lille: {
    ...
    zones: [
      { num: '59', nom: 'Lille', contenu: 'Métropole Lilloise • Sessions en présentiel ou distanciel' },
      ...
      { num: '59', nom: 'Marcq-en-Barœul', contenu: 'Intervention dans vos locaux ou en visio' },
...
export const ILE_DE_FRANCE = {
  ...
  zones: [
    ...
    { num: '75', nom: 'Paris', contenu: 'Tous arrondissements • Sessions présentiel ou distanciel' },
