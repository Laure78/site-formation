...
export const ILE_DE_FRANCE = {
  ...
  customHeroIntro: [
    ...
    'Les sessions sont animées présentiel uniquement · Île-de-France uniquement (intra (dans vos locaux) ou inter). Objectif : repartir avec des prompts, trames et habitudes directement utilisables au bureau comme sur le terrain.',
  ],
  heroBadges: [
