...
export const FORMATION_CITIES: Record<string, CityFormationConfig> = {
  morangis: {
    ...
    customHeroIntro: [
      'Morangis et le bassin de la vallée de l’Orge concentrent artisans, PME du second œuvre et activités de services au bâtiment : la même pression sur les délais que partout ailleurs en Île-de-France — avec l’avantage d’être à proximité des zones d’emploi de Massy, Saclay et des axes vers Paris.',
    ...
    zones: [
      ...
      { num: '91', nom: 'Longjumeau', contenu: 'Artisans, TPE et PME — déplacements courts depuis Guyancourt (78)' },
      { num: '91', nom: 'Massy', contenu: 'Pôle tertiaire et artisanat • créneaux adaptés aux agendas chargés' },
  ...
  longjumeau: {
    ...
    zones: [
      ...
      { num: '91', nom: 'Montlhéry', contenu: 'Artisans et PME du bâtiment sur la RD20 / accès A6' },
