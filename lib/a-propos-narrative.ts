...
export const A_PROPOS_NARRATIVE_PARAGRAPHS: readonly string[] = [
  ...
  `Sur le terrain, j’ai été fondatrice et dirigeante d'ALIA BTP (entreprise de travaux publics — terrassement et revêtements extérieurs, SIRET 853 687 317 00018, Guyancourt) de 2017 à 2024 : management chantier, délais, aléas, recrutement (tests préalables, formation EPI), prospection commerciale, et **digital & SEO** (site vitrine, netlinking, réseaux sociaux). Ce qui m’a marquée, ce sont les écarts entre la complexité réelle des chantiers et la pression administrative — peu de marge pour « expérimenter » si les délais et les clients sont déjà là. Quand l’IA générative a émergé, mon réflexe n’a pas été marketing : c’était opérationnel — montrer comment un prompt bien cadré peut débloquer une rédaction, structurer une pièce ou accélérer une relecture, sans remplacer le métier ni les obligations réglementaires.`,
  ...
  `Côté visibilité et transmission, j’assume aussi un rôle d’**instructrice LinkedIn Learning** (deux cours publiés en 2026 : IA pour le BTP et IA pour le recrutement en TPE) et je forme sur **ChatGPT, Claude, Copilot 365, Mistral AI et Perplexity** — avec des kits prompts Excel par corps de métier. Côté institutions, les collaborations s’appuient sur des acteurs de référence — FFB (Grand Paris, IDF 78/91/95, IDF Est), CAPEB, CSFE, CNAM Entreprise — parce que la crédibilité d’une formatrice IA pour le BTP se joue aussi dans la capacité à parler le langage des corps de métier et des fédérations.`,
