...
export const FORMATION_CHATGPT_BTP_CONFIG: SeoClusterPageConfig = {
  ...
  finalCtaSubtitle:
    'Session intra (dans vos locaux) ou inter — contenu adapté à vos process et à vos équipes.',
  ...
  relatedLinks: [
    ...
    { href: LINKS.formationIaBtpParis, label: 'Formation IA pour le BTP en Île-de-France' },
