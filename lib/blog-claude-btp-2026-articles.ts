...
<figcaption class="mt-2 text-center text-sm text-slate-500">Exemples inspirés du terrain formation : conventions, devis à 1 000 € HT/session, prospection, comptes rendus.</figcaption>
</figure>`,
      },
      {
        type: 'paragraph',
