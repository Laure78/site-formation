...
<figcaption class="mt-2 text-center text-sm text-slate-500">Les ordres de grandeur sont illustratifs : mesurez chez vous avec un pilote.</figcaption>
      ...
      },
      {
        type: 'cta',
        content:
          'Vous souhaitez une session en présentiel (intra (dans vos locaux) ou inter) pour déployer ces assistants avec vos équipes ?',
...
<figcaption class="mt-2 text-center text-sm text-slate-500">« L’IA au service du BTP » — session 4 h, intra (dans vos locaux) ou inter, éligibilité Constructys selon dossier.</figcaption>
</figure>`,
      },
      {
        type: 'paragraph',
