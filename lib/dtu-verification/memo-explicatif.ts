...
export function construireMemoExplicatif(opts: {
  ...
  return [
    ...
    'Pour poursuivre après la phase test : prendre contact avec OFC Création d’Entreprise pour cadrer une solution IA adaptée à votre organisation (formation ou accompagnement métier).',
    'OFC Création d’Entreprise · Formation IA pour le BTP · laureolivie.fr',
  ];
}
