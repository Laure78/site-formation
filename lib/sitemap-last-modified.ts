...
const ROUTE_SOURCE_FILES: Record<string, readonly string[]> = {
  ...
  '/ressources/tuto-skill-pic': [
    'app/ressources/tuto-skill-pic/page.tsx',
    'lib/tuto-skill-pic-content.ts',
  ],
  ...
  '/livret-accueil-stagiaire': ['app/livret-accueil-stagiaire/page.tsx'],
  '/informations-reglementaires': ['app/informations-reglementaires/page.tsx'],
