...
/** Fiche Google Business Profile — avis, horaires, SEO local (lien Maps de partage). */
export const SCHEMA_GOOGLE_BUSINESS_PROFILE_URL =
  'https://maps.app.goo.gl/qPHKWMAceJegYWg8A' as const;
...
export const SCHEMA_PERSON_LAURE = {
  ...
  description:
    `Ancienne dirigeante d’une entreprise de travaux publics (ALIA BTP), Laure Olivié s’appuie sur ${formatAnneesExperienceBTP()} pour former les équipes aux usages concrets de l’intelligence artificielle, en présentiel en Île-de-France.`,
} as const;
...
export const SCHEMA_ORGANIZATION_OFC = {
  ...
  descriptionShortGraph:
    'Organisme de formation certifié Qualiopi spécialisé en formation IA et ChatGPT pour les entreprises du BTP. Finançable par Constructys selon éligibilité.',
  foundingYear: '2021',
} as const;
