...
const PAGES_DATA: { path: string; title: string; content: string }[] = [
  ...
  { path: '/a-propos', title: 'À propos', content: 'Laure Olivié — Formatrice IA spécialisée BTP. OFC Création d\'Entreprise, certification Qualiopi. Partenaires : FFB, CSFE, CAPEB, OPPBTP, LinkedIn Learning, Constructys.' },
  {
