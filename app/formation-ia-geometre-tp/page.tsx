    ...
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <article>
        ...
        <section id="a-propos" className="scroll-mt-24 mt-14">
          ...
          <p className="mt-4 text-slate-600 leading-relaxed">
            <strong>Laure Olivié</strong> accompagne depuis <strong>2023</strong> les professionnels du BTP et les équipes
            TP pour utiliser ChatGPT sur la productivité (devis, communication, dossiers).{' '}
