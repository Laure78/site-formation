...
const CALENDLY_HERO = buildSiteCalendlyCtaUrl('ressources-guide-claude-btp-ofc-hero');
const CALENDLY_FINAL = buildSiteCalendlyCtaUrl('ressources-guide-claude-btp-ofc-final');
