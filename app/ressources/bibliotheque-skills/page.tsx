      ...
      <header className="border-b border-slate-200 bg-white px-4 py-4">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              href="#catalogue"
              className="rounded-lg bg-[#377CF3] px-4 py-2 text-sm font-semibold text-white hover:bg-[#2d66d6]"
            >
              Voir les skills
            </a>
            <Link
              href={LINKS.prendreRdv}
              className="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:border-[#377CF3]"
            >
