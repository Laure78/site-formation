...
const FAQ_IDF: FAQItem[] = [
  {
    ...
    a: `Exclusivement en présentiel en Île-de-France : intra ou inter. Basée à Guyancourt (78), Laure Olivié intervient sur ${IDF_ZONE_INTERVENTION}.`,
  },
  {
      ...
      <article>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <EnBref>
              <p>
                ...
                réels — devis, DCE, mémoires techniques, comptes rendus. Catalogue intra ou inter ; financement OPCO
        ...
        <section className={OFC_SEC.white} aria-labelledby="catalogue-idf-heading">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-600 md:text-lg">
              ...
              uniquement, sessions intra ou inter, sur {IDF_ZONE_INTERVENTION}.
            </p>
            <div className="mt-10">
        ...
        <section className={OFC_SEC.white} aria-labelledby="pourquoi-laure-idf">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-600 md:text-lg">
              Formatrice IA spécialisée BTP depuis 2022, après {formatAnneesExperienceBTP()} comme ancienne dirigeante d’une entreprise de travaux publics (ALIA
