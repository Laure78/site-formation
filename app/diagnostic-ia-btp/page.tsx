...
const quizJsonLd = {
  ...
  about: { '@type': 'Thing', name: 'Formation IA BTP' },
      ...
      <div className="mx-auto max-w-2xl px-4 pb-16">
        ...
        <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 md:p-8">
          ...
          <p className="mt-4 text-slate-700 leading-relaxed">
            ...
            entreprise du bâtiment ou des travaux publics. Conçu par Laure Olivié, formatrice IA BTP certifiée Qualiopi
        ...
        <div className="mt-10">
          <AllerPlusLoin
            variant="compact"
            links={[
              { href: LINKS.formations, label: 'Formation IA BTP' },
