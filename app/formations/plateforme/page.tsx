...
const FAQ = [
  ...
  },
  {
    ...
    a: 'La plateforme Teachizy héberge les contenus pédagogiques et supports de formation IA BTP. BeWork (app.laureolivie.fr) est l’espace de dépôt de demandes MOEX pour le relais administratif chantier — deux services distincts.',
  },
] as const;
