    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <PillarPageHero
        ...
        sideImage={{
          ...
          caption:
            'Formation en intra ou inter, exclusivement en présentiel en Île-de-France — atelier sur poste : le même niveau d’exigence pour votre dossier de financement Constructys.',
        }}
      />
