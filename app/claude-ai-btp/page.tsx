...
import { ClaudeBtpStatsSection } from '@/components/claude/ClaudeBtpStatsSection';
...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Oui. Ce guide est informationnel (interfaces, prompts, usages bâtiment et TP). La fiche catalogue « Maîtriser Claude AI pour le BTP » est la session de 4 h (organisme certifié Qualiopi) — Projets, Skills, Cowork, connecteurs et Claude Code.',
  },
  {
            ...
            <article className="min-w-0 space-y-20 md:space-y-28">
              ...
              <section className="scroll-mt-28" aria-labelledby="gains-temps">
                <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
                  ...
                  <p className="max-w-md text-sm text-[#64748B]">Repères observés en formation OFC.</p>
                </div>
                <div className={`mt-8 ${tableWrap}`}>
                  <table className="w-full min-w-[560px] border-collapse text-left text-sm">
                    <caption className="sr-only">Gains de temps mesurés avec Claude AI en BTP</caption>
                    <thead>
                      <tr className="border-b border-[#E2E8F0] bg-[#EFF6FF]/80">
                        <th className="px-4 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#64748B]">{`Tâche`}</th>
                        <th className="px-4 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#64748B]">{`Sans IA`}</th>
                        <th className="px-4 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#64748B]">{`Avec Claude`}</th>
                        <th className="px-4 py-3.5 text-xs font-semibold uppercase tracking-wider text-[#64748B]">{`Gain`}</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-[#F1F5F9] text-[#334155]">
                      {[
                        ...
                        <tr key={r[0]} className="bg-white transition hover:bg-[#F8FAFC]/80">
                          <th scope="row" className="px-4 py-3.5 font-semibold text-[#0F172A]">
                            {r[0]}
                          </th>
                          <td className="px-4 py-3.5 text-[#64748B]">{r[1]}</td>
                          <td className="px-4 py-3.5">{r[2]}</td>
                          <td className="px-4 py-3.5 font-medium text-[#377CF3]">{r[3]}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <section className="scroll-mt-24" id="prompts" aria-labelledby="bibliotheque-prompts-title">
                <h2
                  id="bibliotheque-prompts-title"
                ...
                <p className="mt-4 max-w-2xl text-sm leading-relaxed text-[#64748B] md:text-base">
                  Copiez-collez dans Claude — adaptez le contexte.
                </p>
                <h3 className="mt-8 font-display text-xl font-bold text-[#0F172A] md:text-2xl">
              ...
              <section className="scroll-mt-24" aria-labelledby="limites">
                <h2 id="limites" className="font-display text-2xl font-bold tracking-tight text-[#0F172A] md:text-3xl">
                  Atouts et limites
                </h2>
                <div className="mt-8 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.05)]">
                    <div className="flex items-center gap-2 text-sm font-semibold text-[#0F172A]">
                      <CheckCircle2 className="h-5 w-5 text-[#377CF3]" aria-hidden />
                  ...
                  <div className="rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC]/90 p-6">
                    <div className="flex items-center gap-2 text-sm font-semibold text-[#0F172A]">
                      <MinusCircle className="h-5 w-5 text-[#94A3B8]" aria-hidden />
                      Ce qui reste métier
                    </div>
                    <p className="mt-3 text-sm leading-relaxed text-[#64748B]">
                ...
                <p className="mt-6 rounded-xl border border-[#E2E8F0] bg-white px-4 py-3 text-sm italic text-[#64748B]">
              ...
              <section className="scroll-mt-28" id="fiches-formation-claude" aria-labelledby="fiches-formation-claude-title">
                <h2
                  ...
                  className="font-display text-2xl font-bold tracking-tight text-[#0F172A] md:text-3xl"
                >
                  Passer à une formation Claude (catalogue — organisme certifié Qualiopi)
                </h2>
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {[
                    ...
                    >
                      ...
                      <p className="mt-auto pt-3 text-sm text-[#64748B]">{c.desc}</p>
                    </Link>
                  ))}
                </div>
                <p className="mt-6 text-sm text-[#64748B]">
