...
export function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-[90] border-t border-slate-200 bg-white/95 p-4 shadow-[0_-8px_30px_rgba(15,23,42,0.12)] backdrop-blur-sm md:p-5"
    >
      <div className="mx-auto flex max-w-5xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap gap-2">
          ...
          <button
            type="button"
            onClick={accept}
            className="rounded-xl bg-[var(--accent)] px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700"
          >
            Accepter
          </button>
        </div>
