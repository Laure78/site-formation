...
export function ClaudeBtpConversionCta() {
  return (
    <PillarConversionCta
      ...
      description={
        <>
          4 h — Qualiopi — financement possible selon éligibilité. Chat, Projets, Cowork, Code, Chrome : intra (dans vos locaux) ou inter,
      ...
      footnote={`FFB Grand Paris, FFB IDF, CSFE, CNAM, Le Moniteur Formations · +$· `}
