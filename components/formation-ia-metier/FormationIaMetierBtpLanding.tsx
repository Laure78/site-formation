        ...
        <article>
          ...
          <div className="mt-12">
            <CalendlyBlock
              ...
              subtitle="30 minutes pour cadrer votre besoin (intra (dans vos locaux) ou inter, en présentiel) et voir si la formation IA appliquée au bâtiment correspond à votre équipe."
            />
          </div>
