...
`site-formation` — le site et la plateforme de **laureolivie.fr** : site vitrine SEO/GEO + LMS (espace apprenant, admin/formateur) pour **OFC Création d'Entreprise**, l'organisme de formation IA/ChatGPT pour le BTP de Laure Olivié. Le site héberge aussi une section **BeWork** (formation pour créer avec l’IA sans savoir coder), un pipeline média/agent et une bibliothèque de skills.
