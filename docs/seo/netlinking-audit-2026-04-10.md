...
| `/formation-ia-btp-paris-2026` utilisée en liens internes | Remplacée par **`/formations/ia-btp-paris`** (canonique SEO). Redirect **301** ajoutée dans `next.config.ts` : `/formation-ia-btp-paris-2026` → `/formations/ia-btp-paris`. La page source peut rester pour les URLs déjà indexées ; le flux de PageRank suit la redirect. |
...
4. `/blog`
5. `/formations/ia-btp-paris` (après canonisation)
