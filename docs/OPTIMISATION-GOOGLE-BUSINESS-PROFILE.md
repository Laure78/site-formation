# Optimisation Google Business Profile — Laure Olivié
...
## Adresse NAP (cohérence avec le site)

- **Nom :** Laure Olivié  
- **Activité :** Formation IA pour entreprises du BTP  
- **Adresse :** 6 Rue Henri Dunant, 78280 Guyancourt  
...
## Description optimisée SEO (750 caractères max)
...
1. **Photo de profil :** Laure Olivié — formatrice (photo professionnelle)
...
5. **Équipe :** Laure Olivié avec partenaires (FFB, CAPEB, etc.)
...
- Formation sur site client : pas d’heures fixes  
- Bureau / téléphone : indiquer des plages de disponibilité réalistes  
...
Encourager les entreprises formées à laisser un avis Google (sans incitation monétaire directe).

---

## Checklist de mise à jour

- [ ] Nom : Laure Olivié — Formation IA BTP  
- [ ] Catégories : Centre de formation, Consultant, Formation professionnelle  
- [ ] Adresse : 6 Rue Henri Dunant, 78280 Guyancourt  
- [ ] Description SEO (750 caractères)  
- [ ] Liens vers formations  
- [ ] 5+ photos professionnelles  
- [ ] Services listés  
- [ ] Heures d’ouverture cohérentes  
