...
### Travail réalisé
✅ **7 tâches complétées** :
1. Schema.org enrichi (stats officielles 1592, 4.85/5, 10 ans, 9 clients institutionnels)
...
```
1. En bref (résumé)
   → 2-5 min vs 1-2h, 1592 formés, 4.85/5
...
7. Formation ChatGPT pour devis BTP : comment aller plus loin ?
   → Laure Olivié, 1592 formés, 4.85/5, Constructys
8. FAQ 5 Q&A
...
- Mention des stats : 1592 formés, 4.85/5, Guyancourt (78)
...
### Page /a-propos
- [x] Bio dense en faits vérifiables (1592, 4.85/5, 10 ans)
...
- [x] Stats officielles incluses (1592, 4.85/5)
...
- [x] Faits répétés (1592, 4.85/5, Guyancourt)
...
```
lib/seo.ts                  → Schema Person enrichi (1592, 4.85/5, 9 affiliations)
...
✅ **Schema.org enrichi** avec 1592, 4.85/5, 9 clients  
